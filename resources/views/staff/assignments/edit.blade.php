<x-master-layout>
    <div class="fade-in">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">Update the details for "{{ $assignment->title }}"</p>
        </div>
                ...
                <form action="{{ route('staff.assignments.update', $assignment) }}" method="POST"
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm">{{ old('description', $assignment->description) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <x-input-label for="file" :value="__('Update Attachment (Optional)')" />
                            ...
                            @if($assignment->file_path)
                                <p class="mt-1 text-xs text-blue-600">Current: {{ basename($assignment->file_path) }}</p>
                            @endif
