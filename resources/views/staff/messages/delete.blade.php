<x-master-layout>
    <div class="flex items-center justify-center min-h-[80vh]">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 max-w-lg w-full text-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Delete Message?</h2>
            <p class="text-gray-500 mb-6">Are you sure you want to delete this message?</p>
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left border border-gray-100">
                ...
                <div class="flex items-center mt-3 pt-3 border-t border-gray-200">
                    ...
                    <div>
                        <p class="text-xs text-gray-500">From: <span
                                class="font-medium text-gray-700">{{ $message->sender->name }}</span></p>
                        <p class="text-[10px] text-gray-400">{{ $message->created_at->format('M d, Y @ h:i A') }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>This will permanently delete this message from your records. This action cannot be
                                undone.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex space-x-4">
                ...
                <form action="{{ route('staff.messages.destroy', $message) }}" method="POST" class="w-1/2">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
