    ...
    <div class="fade-in">
        <div class="mb-6 flex justify-between items-center">
             <div>
                ...
                <h1 class="text-2xl font-bold text-gray-800">Fee Status: {{ $student->first_name }} {{ $student->last_name }}</h1>
            </div>
        ...
        @if($fees->isEmpty())
             <div class="bg-white rounded-xl shadow-sm p-8 text-center border border-gray-100">
                ...
                <p class="text-gray-500">There are no fee records available for this student.</p>
            </div>
        @else
            ...
            <div class="mt-8 bg-blue-50 border border-blue-100 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-blue-700 text-sm">You can pay fees online securely using your credit card or bank transfer.</p>
                </div>
                {{-- Placeholder for Payment Gateway Integration --}}
                <button class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-md transition transform hover:-translate-y-0.5">
