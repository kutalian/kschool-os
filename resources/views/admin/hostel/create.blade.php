<x-master-layout>
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Add New Hostel</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="Mixed" {{ old('type') == 'Mixed' ? 'selected' : '' }}>Mixed Hostel</option>
                            </select>
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <label for="warden_name" class="block text-sm font-medium text-gray-700 mb-1">Warden
                                Name</label>
                            <input type="text" name="warden_name" id="warden_name" value="{{ old('warden_name') }}"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">{{ old('description') }}</textarea>
                        </div>
                    </div>
