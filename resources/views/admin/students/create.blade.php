<x-master-layout>
    ...
    <form action="{{ route('students.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex justify-between items-center mb-4 border-b pb-2">
                ...
                <a href="{{ route('parents.create') }}" target="_blank"
                    class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                    <i class="fas fa-plus-circle mr-1"></i> Add New Parent
                </a>
            </div>

            <!-- Hidden input to satisfy backend validation -->
            <input type="hidden" name="parent_choice" value="existing">
            ...
            <div class="bg-blue-50 p-4 rounded-xl border border-blue-100 mb-6">
                <p class="text-blue-800 text-sm flex items-center gap-2">
                    ...
                    Search for a parent by name, email, or phone number. If the parent is not in the list, please add
    ...
    return ['id' => $p->id, 'name' => $p->name, 'phone' => $p->phone, 'email' => $p->email];
                ...
                <label class="block text-gray-700 text-sm font-bold mb-2">Search Parent <span
                        class="text-red-500">*</span></label>
                <input type="hidden" name="parent_id" :value="selectedParent ? selectedParent.id : ''" required>
