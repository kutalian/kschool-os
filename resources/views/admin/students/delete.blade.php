<x-master-layout>
    <div class="flex items-center justify-center min-h-[80vh]">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 max-w-lg w-full text-center">
            ...
            <p class="text-gray-500 mb-6">This student has related records in the system.</p>
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Admission No: {{ $student->admission_no }} | Class:
            ...
            <div class="text-left mb-6">
                <h4 class="text-sm font-bold text-yellow-700 mb-2 flex items-center">
                    <i class="fas fa-link mr-2"></i> Related Records Found:
                </h4>
                <div
                    ...
                    <span
                        class="bg-yellow-200 text-yellow-900 py-1 px-3 rounded-full text-xs font-bold">{{ $attendanceCount }}</span>
                </div>
                <!-- Future related records can be added here -->
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>Clicking "Delete All" will permanently remove the student and <strong>ALL</strong>
                                related records listed above. This action cannot be undone.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex space-x-4">
                ...
                <form action="{{ route('students.destroy', $student->id) }}" method="POST" class="w-1/2">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
