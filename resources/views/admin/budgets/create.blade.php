<x-master-layout>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Allocate Budget</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden p-6 max-w-2xl mx-auto">
        <form action="{{ route('budgets.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="academic_year" id="academic_year" value="{{ $currentYear }}" readonly
                ...
                <p class="text-xs text-gray-500 mt-1">Budgets are allocated for the current academic year.</p>
            </div>

            <div class="mb-4">
                <label for="category" class="block text-sm font-medium text-gray-700">Expense Category <span
                        class="text-red-500">*</span></label>
                <input list="category_options" name="category" id="category"
            ...
            <div class="mb-4">
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                    ...
                    <input type="number" name="allocated_amount" id="allocated_amount" min="0" step="0.01"
