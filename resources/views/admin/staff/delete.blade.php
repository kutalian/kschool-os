<x-master-layout>
    <div class="flex items-center justify-center min-h-[80vh]">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 max-w-lg w-full text-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Delete Staff Member?</h2>
            <p class="text-gray-500 mb-6">Are you sure you want to delete this staff member?</p>

            <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left border border-gray-100">
                <div class="flex items-center">
                    <div
                        class="h-10 w-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 font-bold mr-3">
                        {{ substr($staff->name, 0, 1) }}
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-900">{{ $staff->name }}</h3>
                        <p class="text-sm text-gray-500">ID: {{ $staff->employee_id }} | Role: {{ $staff->role_type }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-left mb-6">
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <span>Active Classes (Teacher)</span>
                    </div>
                    <span
                        class="bg-yellow-200 text-yellow-900 py-1 px-3 rounded-full text-xs font-bold">{{ $classesCount }}</span>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>This will permanently delete the staff profile and their <strong>User Account</strong>.
            ...
            <div class="flex space-x-4">
                ...
                <form action="{{ route('staff.destroy', $staff->id) }}" method="POST" class="w-1/2">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
