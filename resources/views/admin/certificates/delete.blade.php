<x-master-layout>
    <div class="flex items-center justify-center min-h-[80vh]">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 max-w-lg w-full text-center">
            ...
            <p class="text-gray-500 mb-6">Are you sure you want to delete this certificate?</p>
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-900">{{ $certificate->certificate_type }}</h3>
                        <p class="text-sm text-gray-500">Student: {{ $certificate->student->name }} | Code:
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>This action will move the certificate to the trash (Soft Delete). It can be restored
                                later if needed.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex space-x-4">
                ...
                <form action="{{ route('certificates.destroy', $certificate->id) }}" method="POST" class="w-1/2">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
