<x-master-layout>
    <div class="flex items-center justify-center min-h-[80vh]">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 max-w-lg w-full text-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Delete Subject?</h2>
            <p class="text-gray-500 mb-6">Are you sure you want to delete this subject?</p>
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Code: {{ $subject->code }} | Type: {{ $subject->type }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>This will permanently delete the subject and unassign it from all classes. This action
                                cannot be undone.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex space-x-4">
                ...
                <form action="{{ route('subjects.destroy', $subject->id) }}" method="POST" class="w-1/2">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
